...
public class FriendController {
	...
	public List<Friend> getByUser(@PathVariable("userId")int userId) {
		List<Friend> listOfSendingReq = friendDAO.getByUser(userId);
		List<Friend> listOfRecivingReq = friendDAO.getByUser1(userId);
		listOfSendingReq.addAll(listOfRecivingReq);
		return listOfSendingReq;
	}
